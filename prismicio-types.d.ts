...
export interface ExperienceSliceDefaultPrimary {
  /**
   * Experience Heading field in *Experience → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
...
/**
 * Primary content in *ExperienceBody → Default → Primary*
 */
export interface ExperienceBodySliceDefaultPrimary {
  /**
   * Title field in *ExperienceBody → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience_body.default.primary.title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Time Period field in *ExperienceBody → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience_body.default.primary.time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_period: prismic.KeyTextField;

  /**
   * Institution field in *ExperienceBody → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience_body.default.primary.institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  institution: prismic.KeyTextField;

  /**
   * Description field in *ExperienceBody → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience_body.default.primary.description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
/**
 * Default variation for ExperienceBody Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExperienceBodySliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ExperienceBodySliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *ExperienceBody*
 */
type ExperienceBodySliceVariation = ExperienceBodySliceDefault;

/**
 * ExperienceBody Shared Slice
 *
 * - **API ID**: `experience_body`
 * - **Description**: ExperienceBody
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExperienceBodySlice = prismic.SharedSlice<
  "experience_body",
  ExperienceBodySliceVariation
>;
...
/**
 * Item in *TechList → Default → Primary → Tech I use*
 */
export interface TechListSliceDefaultPrimaryFieldItem {
  /**
   * Tech Name field in *TechList → Default → Primary → Tech I use*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.field[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Tech Color field in *TechList → Default → Primary → Tech I use*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.field[].tech_color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech I use field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.field[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  field: prismic.GroupField<Simplify<TechListSliceDefaultPrimaryFieldItem>>;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ExperienceBodySlice,
      ExperienceBodySliceDefaultPrimary,
      ExperienceBodySliceVariation,
      ExperienceBodySliceDefault,
      HeroSlice,
      ...
      TechListSlice,
      TechListSliceDefaultPrimaryFieldItem,
